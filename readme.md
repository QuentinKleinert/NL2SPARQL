...
1. Lege ein temporäres Arbeitsverzeichnis an und klone das Forschungs-Repository deiner Professorin:
   ```bash
   mkdir -p tmp
...
_Stand: 2025-10-04 – bitte README nach größeren Änderungen an UI/Backend aktualisieren._
